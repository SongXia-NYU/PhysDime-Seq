...
#         val_data_loader = [load_data_from_index(data_provider, index) for index in valid_index_loader]
...
#         test_data_loader = [load_data_from_index(data_provider, index) for index in test_index_loader]
